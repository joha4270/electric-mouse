(function ($)
{
    ...
    *
    * @type {{tagClass: tagClass, itemValue: itemValue, itemText: itemText, itemTitle: itemTitle, itemImage: itemImage, itemUserId: itemUserId, freeInput: boolean, addOnBlur: boolean, maxTags: undefined, maxChars: undefined, confirmKeys: number[], onTagExists: onTagExists, trimValue: boolean, allowDuplicates: boolean}}
    */
    var defaultOptions = {
        tagClass                    : tagClass,
        itemValue                   : itemValue,
    ...
    TagsMaterialize.prototype = {
        ...
        */
        add : function (item, dontPushVal, options)
        {
            ...
            var itemValue = self.options.itemValue(item),
	            ...
	            itemImage = self.options.itemImage(item)
	            itemUserId= self.options.itemUserId(item);
            ...
            // add a tag element
	        var imageText = "";
	        if(itemImage != "") {imageText = '<img src="' + itemImage + '" alt="Contact Person">';}
		        var $tag = $('<span class="' + htmlEncode(tagClass) + (itemTitle !== null ? ('" title="' + itemTitle) : '') + '">' + imageText + htmlEncode(itemText) + '<i class="material-icons" data-role="remove">close</i></span>');
            $tag.data('item', item);
        ...
        */
        build : function (options)
        {
	        ...
	        makeOptionItemFunction(self.options, 'itemImage');
	        makeOptionItemFunction(self.options, 'itemUserId');
